...
//    progressView = (View) findViewById(R.id.indeterminate_progress_indicator_view);
    ...
    isEngineReady = false;
      ...
      final Button ckeck = (Button) findViewById(R.id.buttonshr);
      ckeck.setOnClickListener(new View.OnClickListener() {
          @Override
          public void onClick(View v) {
              Intent i = new Intent(CaptureActivity.this, shareCredit.class);
              startActivity(i);
          }
      });

      final Button balance = (Button) findViewById(R.id.buttonblnc);
  ...
  private void initOcrEngine(File storageRoot, String languageCode, String languageName) {    
    ...
    indeterminateDialog.setMessage("Initializing Smart Reload app for " + languageName + "...");
